        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td class="text-center"><a class="text-danger mx-2 py-0 btn btn-outline-danger" href="?application_no=<?= $_GET['application_no'] ?>&remove=<?= htmlentities($stud_sub['id']) ?>">x</td>
                </tr>
            <?php endforeach; ?>
        </tbody>
        <tfoot>
