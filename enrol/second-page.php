    ...
    <div id="outprint" style="font-size: smaller;">
        ...
        <tbody>
            ...
            ?>
                <tr>
                    <?php 
                        if (strtoupper($row['enroll_status']) == 'IRREGULAR' || strtoupper($row['enroll_status']) == 'SHIFTEE') {
                            ?>
        ...
        <tfoot>
            <tr>
                ...
                <td class="sub-column" colspan=" <?= strtoupper($row['enroll_status']) != 'REGULAR' ? 3 : 2 ?> " style="text-align: right;"><strong>Numbers of Units Applied: </strong></td>
