...
<body>
    ...
    <div id="outprint" style="font-size: smaller;">
       ...
       <img src="r2.jpg" alt="MCC Logo" style="height: 90px; width: 800px;">
            ...
            <a href="last-page.php?application_no=<?= $id ?>" class="btn btn-danger mb-3 mx-auto w-25" onclick="document.getElementById('final_process').classList.remove('d-none'); this.classList.add('d-none')" id="to_assessment">Next</a>
