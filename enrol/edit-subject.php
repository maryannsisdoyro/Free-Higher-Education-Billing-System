...
<?php include './topbar.php' ?>
    ...
    <main class="container p-3" id="view-panel">
        <div class="form-container">
            <h2>Edit Subject</h2>
            <form id="Subjectform" action="updatesub.php" method="post">
                <input type="hidden" name="id" value="<?= $row['id'] ?>">
                <div class="form-group">
                    <label for="Semester">Semester</label>
                    <select class="form-control" id="Semester" name="Semester" required>
                        <option value="">Select Semester</option>
                        <option value="1st" <?= $row['sem'] == '1st' ? 'selected' : '' ?>>1st</option>
                        <option value="2nd" <?= $row['sem'] == '2nd' ? 'selected' : '' ?>>2nd</option>
                        <option value="Summer" <?= $row['sem'] == 'Summer' ? 'selected' : '' ?>>Summer</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="Year" name="Year" required>
                        ...
                        <option value="1st" <?= $row['year'] == '1st' ? 'selected' : '' ?>>1st</option>
                        <option value="2nd" <?= $row['year'] == '2nd' ? 'selected' : '' ?>>2nd</option>
                        <option value="3rd" <?= $row['year'] == '3rd' ? 'selected' : '' ?>>3rd</option>
                        <option value="4th" <?= $row['year'] == '4th' ? 'selected' : '' ?>>4th</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="Course" name="Course" required>
                        ...
                        <option value="BSED" <?= $row['course'] == 'BSED' ? 'selected' : '' ?>>BSED</option>
                        <option value="BSIT" <?= $row['course'] == 'BSIT' ? 'selected' : '' ?>>BSIT</option>
                        <option value="BS-HM" <?= $row['course'] == 'BS-HM' ? 'selected' : '' ?>>BSHM</option>
                        <option value="BSBA" <?= $row['course'] == 'BSBA' ? 'selected' : '' ?>>BSBA</option>
                    </select>
                </div>
              ...
              <div class="form-group">
               <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="Time" name="Time" 
                    ...
                    placeholder="Enter time range (e.g., 1:00-2:00)" value="<?= $row['tbl_time'] ?>" required>
              </div>
                ...
                <div class="form-group">
                    <label for="Day">Day</label>
                     <select class="form-control" id="Day" name="Day" required>
                        ...
                        <option value="MWF" <?= $row['tbl_day'] == 'MWF' ? 'selected' : '' ?>>MWF</option>
                        <option value="TTH" <?= $row['tbl_day'] == 'TTH' ? 'selected' : '' ?>>TTH</option>
                        <option value="MW" <?= $row['tbl_day'] == 'MW' ? 'selected' : '' ?>>MW</option>
                        <option value="WED" <?= $row['tbl_day'] == 'WED' ? 'selected' : '' ?>>WED</option>
                        <option value="THU" <?= $row['tbl_day'] == 'THU' ? 'selected' : '' ?>>THU</option>
                        <option value="FRI" <?= $row['tbl_day'] == 'FRI' ? 'selected' : '' ?>>FRI</option>
                        <option value="SAT" <?= $row['tbl_day'] == 'SAT' ? 'selected' : '' ?>>SAT</option>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="Subjectcode" name="Subjectcode"required  oninput="updatesubjectUPPER(this);" value="<?= $row['subjectcode'] ?>">
                </div>
                
                <div class="form-group">
                    <label for="Subjectdes">Subject Description</label>
                    <input type="text" class="form-control" id="Subjectdes" name="Subjectdes"required  oninput="updatesubjectUPPER(this);" value="<?= $row['subdes'] ?>">
                </div>
                
                <div class="form-group">
                    <label for="Prerequi">Pre-Requisites/s</label>
                    <input type="text" class="form-control" id="Prerequi" name="Prerequi"required oninput="updatesubjectUPPER(this);" value="<?= $row['prerequi'] ?>">
                </div>
                 <!--  SELECT `id`, `sem`, `year`, `course`, `time`, `day`, `subjectcode`, `subdes`, `prerequi`, `units`, `room`, `strand` FROM `subject` WHERE 1 -->
                <div class="form-group">
                    <label for="Units">Units</label>
                    <input type="text" class="form-control" id="Units" name="Units" value="<?= $row['units'] ?>" required>
                </div>
                
                <div class="form-group">
                    <label for="Room">Room</label>
                    <input type="text" class="form-control" id="Room" name="Room" required oninput="updatesubjectUPPER(this);" value="<?= $row['room'] ?>">
                </div>      
                   <div class="form-group">
                    <label for="Instructor">Instructor</label>
                    <input type="text" class="form-control" id="Instructor" name="Instructor" required oninput="updatesubjectUPPER(this);" value="<?= $row['inst'] ?>">
                </div>     
