...
<div style="margin-top: 20px;" class="">
			...
			<table id="example2" class="table table-bordered table-hover">
                ...
                if ($get_course->num_rows > 0) {
                    ...
                    $query_subjects = mysqli_query($conn, "SELECT * FROM subject WHERE year = '". $fetch_course['level'] ."' AND course = '".$fetch_course['department']."' AND sem = '".$row['semester']."'");
                    
// echo $fetch_course['level']
