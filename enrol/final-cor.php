...
<div style="margin-top: 20px;" class="">
			...
			<table id="example2" class="table table-bordered table-hover">
                ...
                if ($get_course->num_rows > 0) {
                    ...
                    $query_subjects = $conn->query("SELECT * FROM subject WHERE course = '" . $fetch_course['department'] == 'BS-HM' ? 'BSHM' : $fetch_course['department'] . "' AND sem = '" . $fetch_course['semester'] . "' AND year = '" . $fetch_course['level'] . "'");
