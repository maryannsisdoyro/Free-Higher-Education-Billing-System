...
<head>
    ...
    <title><?= $row['stu_id'] . " ". ucfirst(strtolower($row['fname'])) . " " . ucfirst(strtolower($row['lname'])) . " " . $row['course'] . " " . $row['year_level'] . "-". $row['section']?></title>
            ...
            //   echo $totalUnits;
                ...
                // if ($get_course->num_rows > 0) {
                    ...
                    <tr>
                        ...
                        <td colspan="3" class="text-right"><b><?php echo number_format(abs($subject_total - ($subject_total + $ftotal)), 2);
 ?></b></td>
                    </tr>
                    <?php
                // }
