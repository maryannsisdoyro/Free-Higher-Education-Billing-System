...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
 ...
 <div class="college-application">
        ...
        <div class="form-section">
            ...
            <tr>
                <th><center>SHS Track and Strand taken</center></th>
                <td colspan="5"><center><?php echo $track_and_strand; ?></center></td>
            </tr>
        </table>
        ...
        <p style="margin-left: 120px; margin-top: 10px;"><br>
            <strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $complete_name; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $date_signed; ?></strong><br>
