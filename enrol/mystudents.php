                    ...
                    if ($result->num_rows > 0) {
                        while($row = $result->fetch_assoc()) {
                            echo "<tr>
                                    ...
                                    <td><button class='btn btn-info'>Action</button></td> <!-- Action button -->
                                  </tr>";
                        }
                    } else {
