 ...
 <div class="college-application">
        ...
        <tr>
         ...
         <tr>
            ...
            <td colspan="2"><center>2024-2025</center> </td>
         ...
         <tr>
            ...
            <td colspan="3"style="text-transform: uppercase;"><center><?php echo $home_address; ?></center></td>
         ...
         <tr>
            ...
            <td colspan="2"style="text-transform: uppercase;"><center><?php echo $date_of_birth; ?></center></td>
         ...
         <tr>
            ...
            <td colspan="3"style="text-transform: uppercase;"><center><?php echo $elementary; ?></center></td>
         ...
         <tr>
            ...
            <td colspan="3"style="text-transform: uppercase;"><center><?php echo $high_school; ?></center></td>
            <td colspan="5" style="text-align: center;"><strong>S.Y.</strong></td>
            <td colspan="5" style="text-align: center;">
             <?php 
             if ($high_school_year_graduated && preg_match('/^\d{4}$/', $high_school_year_graduated)) {
         ...
         <tr>
            ...
            <td colspan="3"style="text-transform: uppercase;"><center><?php echo $shs; ?></center></td>
            <td colspan="5" style="text-align: center;"><strong>S.Y.</strong></td>
           <td colspan="5" style="text-align: center;">
             <?php 
             if ($shs_year_graduated && preg_match('/^\d{4}$/', $shs_year_graduated)) {
...
<table class="table table-bordered table-hover" style="font-size: small;">
    <thead>
        <tr>
            <th colspan="7"><center><h4 style="font-size: 15px;"><strong>ASSESSMENT</strong></h4></center></th>
        </tr>
    </thead>
    <tbody id="feeDetails">
        <tr>
