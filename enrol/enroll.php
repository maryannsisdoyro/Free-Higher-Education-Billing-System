...
$duplicate_check_query = "SELECT * FROM students WHERE last_name = ? AND first_name = ?";
...
if ($result->num_rows > 0) {
    ...
    echo '<button style="padding: 5px 10px; background-color: #ff0000; color: #f2f2f2; border: none; border-radius: 3px; cursor: pointer;" ><a style="color: #f2f2f2;" href="index.php">Go Back </a></button>'; 
    echo '</div>';
    exit;
}
