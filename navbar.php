...
<nav id="sidebar" class='mx-lt-5 bg-danger dont-print' >
		...
		<div class="sidebar-list">
				...
				<div class="dropdown" style="background: #ffffffc4; border: 1px solid rgba(0,0,0,.125); padding: 10px 20px ;" >
					...
					<a href="../index.php?page=downloadable_form" style="font-size: 12px; font-weight: 600;" class="nav-item nav-site_settings"><span class='icon-field'><i class="fa fa-download"></i></span> Student Form</a>
					</div>
				</div>
