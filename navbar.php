...
<nav id="sidebar" class='mx-lt-5 bg-danger dont-print' >
		...
		<div class="sidebar-list">
				...
				<a href="enrol/students.php" class="nav-item nav-students"><span class='icon-field mr-2'><i class="fa fa-users "></i></span> Students</a>
			...
			<?php endif; ?>
			<a href="./enrol/settings.php" class="nav-item nav-settings"><span class='icon-field mr-2'><i class="fa fa-wrench"></i></span> Settings</a>
		</div>
