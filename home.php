...
var yValues = [<?php echo $get_bsit->num_rows ?? 0 ?>, <?php echo $get_bsba->num_rows ?? 0 ?>, <?php echo $get_bshm->num_rows ?? 0 + $get_bs_hm->num_rows ?? 0 ?>, <?php echo $get_bsed->num_rows ?? 0 ?>, <?php echo $get_beed->num_rows ?? 5 ?>];
